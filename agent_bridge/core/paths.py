...
Paths are anchored at the *project root* (`agent_bridge`'s grandparent),
...
# Project root = directory containing the `agent_bridge` package
# (this file is at agent_bridge/core/paths.py → parents[2])
